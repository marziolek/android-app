...
public class PreviewGifPlayer extends View {
	...
	public PreviewGifPlayer(Context context) {
		this(context, null);
	}

	public PreviewGifPlayer(Context context, AttributeSet attrs) {
		this(context, attrs, R.styleable.CustomTheme_gifMoviewViewStyle);
	}

	public PreviewGifPlayer(Context context, AttributeSet attrs, int defStyle) {
	...
	private void setViewAttributes(Context context, AttributeSet attrs, int defStyle) {
		...
		final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.PreviewGif, defStyle,
				R.style.Widget_PreviewGif);

		mMovieResourceId = array.getResourceId(R.styleable.PreviewGif_gif, -1);
		mPaused = array.getBoolean(R.styleable.PreviewGif_paused, false);
